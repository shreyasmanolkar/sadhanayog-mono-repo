...
| `.codex/config.toml` | [SY-0015](../issue-tracking/issues/SY-0015.md) | Context7 + Cloudflare docs declared. Playwright commented. GitHub/log/database MCP not added (intentional). |
