...
Read-only evidence about the two legacy applications. This directory is
the behavioral baseline, not the target product.
...
- Do not invent missing pages, columns, or rules. If the source does not
